...
def main():
    ...
    parser.add_argument('--test_frames_2d', action='store_true',
        help='download 2D test frames (' + TEST_FRAMES_FILE[1] + '; also included with whole dataset download)')
    parser.add_argument('--type',
        help='specific file type to download (.aggregation.json, .sens, .txt, _vh_clean.ply, ' \
        '_vh_clean_2.0.010000.segs.json, _vh_clean_2.ply, _vh_clean.segs.json, ' \
        '_vh_clean.aggregation.json, _vh_clean_2.labels.ply, _2d-instance.zip, ' \
        '_2d-instance-filt.zip, _2d-label.zip, _2d-label-filt.zip)')
